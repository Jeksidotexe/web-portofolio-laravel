...
class halamanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('halaman.index')->with('success', 'Data telah berhasil ditambahkan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('halaman.index')->with('success', 'Data telah berhasil diubah');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('halaman.index')->with('success', 'Data telah berhasil dihapus');
    }
}
