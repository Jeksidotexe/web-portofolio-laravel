    ...
    <form action="{{ route('profil.update') }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="row justify-content-beetwen">
        ...
        <div class="col-5">
          ...
          <div class="mb-3">
            <label for="_discord" class="form-label">Discord</label>
            <input type="text" class="form-control form-control-sm"
            name="_discord" id="_discord" value="{{ get_meta_value('_discord') }}">
          </div>
          <div class="mb-3">
              <label for="_instagram" class="form-label">Instagram</label>
              <input type="text" class="form-control form-control-sm" 
              name="_instagram" id="_instagram" value="{{ get_meta_value('_instagram') }}">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-sm" 
            name="_youtube" id="_youtube" value="{{ get_meta_value('_youtube') }}">
          </div>
